...
void NaiveEngineUtil::SelectFont(int size, const char* face)
{
	std::string facePath;
#ifdef _WIN32
...
void NaiveEngineUtil::DrawString(std::wstring str)
{
	glColor4ub(0, 0, 0, 0);
...
void NaiveEngineUtil::RasterStringSelectFont(int size, int charset, const char* face) {
...
void NaiveEngineUtil::DrawRasterString(GLfloat x, GLfloat y, const char* str)
{
